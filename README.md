...
1. Разделил бы API и Processing на отдельные части, это даст нам независимое масштабирование, отказоустойчивость и обработка продолжится даже если API недоступно.
